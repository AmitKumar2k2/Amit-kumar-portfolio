  ...
  return (
    <aside className="fixed left-0 top-0 w-80 h-screen bg-black p-8 flex flex-col">
      <div className="flex-1 flex flex-col items-center">
        ...
        {/* Action Buttons */}
        <div className="w-full space-y-3 mb-8">
          <button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3 px-4 rounded-xl font-medium transition-colors duration-200 flex items-center justify-center">
